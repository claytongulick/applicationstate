...
describe('Walk function', () => {
    it('should walk through and return proper meta-data for a reference with only objects', () => {
    ...
    it('should walk through and return proper meta-data for a reference with objects and arrays', () => {
    ...
    it('should walk through and return proper meta-data for a reference with an array at the end', () => {
    ...
    it('should walk through and return proper meta-data for a reference with an array within an array', () => {
    ...
    it("should gracefully handle greater than single digit numbers", () => {
    ...
    it("should throw a fit if you try to make the root node an array", () => {
        const reference = "[10]";
